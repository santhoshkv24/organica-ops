...
const CompaniesMUI = React.lazy(() => import('../views/companies/CompaniesMUI'));
...
const ProjectsMUI = React.lazy(() => import('../views/projects/ProjectsMUI'));
...
// Inventory Loans
const InventoryLoanDashboard = React.lazy(() => import('../views/inventory-loans/InventoryLoanDashboard'));
const InventoryLoanForm = React.lazy(() => import('../views/inventory-loans/InventoryLoanForm'));
const InventoryLoanDetails = React.lazy(() => import('../views/inventory-loans/InventoryLoanDetails'));
    ...
    <Suspense fallback={loading}>
      <Routes>
        ...
        <Route path="/" element={<ProtectedRoute><DefaultLayout /></ProtectedRoute>}>
          ...
          <Route path="companies" element={<EmployeeRoute><CompaniesMUI /></EmployeeRoute>} />
          ...
          <Route path="projects" element={<EmployeeRoute><ProjectsMUI /></EmployeeRoute>} />
          ...
          {/* Inventory Loans routes */}
        <Route path="/inventory-loans" element={<ProtectedRoute><InventoryLoanDashboard /></ProtectedRoute>} />
        <Route path="/inventory-loans/create" element={<ProtectedRoute><InventoryLoanForm /></ProtectedRoute>} />
        <Route path="/inventory-loans/:loanId" element={<ProtectedRoute><InventoryLoanDetails /></ProtectedRoute>} />
